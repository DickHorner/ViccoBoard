...
## Scope Lock
- Primary issue: $(@{Id=P6-3; Name=Alternative Grading (++/+/0/-/--); PriorityLine=**Priority:** MEDIUM | **Effort:** 1 day; Description=Implement alternative grading system option.; Tasks=System.Object[]; Acceptance=System.Object[]; RelatesTo=Plan.md §6.11 (Alternative Bepunktung)}.Id)"
  ...
  if(@{Id=P6-3; Name=Alternative Grading (++/+/0/-/--); PriorityLine=**Priority:** MEDIUM | **Effort:** 1 day; Description=Implement alternative grading system option.; Tasks=System.Object[]; Acceptance=System.Object[]; RelatesTo=Plan.md §6.11 (Alternative Bepunktung)}.PriorityLine){ # Copilot Prompt - [P6-3] Alternative Grading (++/+/0/-/--)  You are in STRICT COMPLIANCE mode for ViccoBoard.  ## Mandatory Reading (before any action) - `.github/copilot-instructions.md` - `agents.md` - `Plan.md` (especially section 6 and section 9) - `docs/agents/SPORTZENS_PARITY_v2.md` - `docs/planning/ISSUES_TRACKER.md` - `docs/status/STATUS.md`  ## Execution Mode - Declare mode at start: `AUDIT` or `IMPLEMENTATION`. - For this run, use `IMPLEMENTATION`. - Keep verification language strict: use `VERIFIED`, `GAP`, `NOT VERIFIED` only with evidence.  ## Scope Lock += 
## Issue Description
