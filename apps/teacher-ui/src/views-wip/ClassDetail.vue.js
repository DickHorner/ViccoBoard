...
if (__VLS_ctx.classGroup) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [classGroup, classGroup, showEditModal,];
            } },
        ...{ class: "btn-primary" },
    });
    /** @type {__VLS_StyleScopedClasses['btn-primary']} */ ;
...
if (__VLS_ctx.loading) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [classGroup, classGroup, classGroup, classGroup, loading, error, error, loadData, students, getGradingSchemeDisplay, formatDate, showAddStudentModal,];
            } },
    ...
    if (__VLS_ctx.loadingStudents) {
        ...
        for (const [student] of __VLS_vFor((__VLS_ctx.students))) {
            ...
            if (student.dateOfBirth) {
                __VLS_asFunctionalElement1(__VLS_intrinsics.p, __VLS_intrinsics.p)({});
                (student.dateOfBirth.getFullYear());
            }
            __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
                ...{ class: "student-arrow" },
            });
