...
describe('GradeCategoryRepository', () => {
    let storage;
    let repository;
    let classGroupRepository;
    let testClassGroupId;
    beforeEach(async () => {
    ...
    describe('create', () => {
        ...
        test('creates a Cooper test category', async () => {
            ...
            const cooperConfig = result.configuration;
    ...
    describe('findByClassGroupAndType', () => {
        test('filters by both class group and type', async () => {
            ...
            const categories = await repository.findByClassGroupAndType(testClassGroupId, Sport.GradeCategoryType.Criteria);
