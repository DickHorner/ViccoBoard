...
export function renderCorrectionSessionRules(rules: Exams.CorrectionSessionRules): string {
  return [
    ...
    `- deductionGovernance.applyWhenPointsBelowMaxPoints: ${rules.deductionGovernance.applyWhenPointsBelowMaxPoints ? 'yes' : 'no'}`,
    `- deductionGovernance.requireDefectStatement: ${rules.deductionGovernance.requireDefectStatement ? 'yes' : 'no'}`,
    `- deductionGovernance.requireEvidenceForDeductions: ${rules.deductionGovernance.requireEvidenceForDeductions ? 'yes' : 'no'}`,
    `- deductionGovernance.requireExplanationForAnyNonFullScore: ${rules.deductionGovernance.requireExplanationForAnyNonFullScore ? 'yes' : 'no'}`,
    `- deductionGovernance.rejectUnjustifiedDeductions: ${rules.deductionGovernance.rejectUnjustifiedDeductions ? 'yes' : 'no'}`,
    `- deductionGovernance.minimumDeductionStepRequiresJustification: ${rules.deductionGovernance.minimumDeductionStepRequiresJustification ? 'yes' : 'no'}`,
    `- deductionGovernance.onMissingDefect: ${rules.deductionGovernance.onMissingDefect}`,
    `- deductionGovernance.onMissingEvidence: ${rules.deductionGovernance.onMissingEvidence}`,
