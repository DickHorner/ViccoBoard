...
import { CommentManagementService, CorrectionCommentUseCase } from '../src/services/comment-management.service';
describe('CommentManagementService', () => {
    ...
    describe('createComment', () => {
        ...
        it('should create comment with custom parameters', () => {
            const comment = CommentManagementService.createComment('Custom comment', 'task-2', 'subtask', false, false);
    ...
    describe('validateComment', () => {
        ...
        it('should reject invalid level', () => {
            const invalid = { ...testComment, level: 'invalid' };
            const result = CommentManagementService.validateComment(invalid);
            expect(result.valid).toBe(false);
        });
    });
