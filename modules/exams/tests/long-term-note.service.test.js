 ...
 */
import { LongTermNoteManagementService, LongTermNoteUIHelper } from '../src/services/long-term-note.service';
describe('LongTermNoteManagementService', () => {
    ...
    describe('createLongTermNote', () => {
        it('should create a new long-term note', () => {
            const result = LongTermNoteManagementService.createLongTermNote('student-1', 'class-1', '2024-2025');
    ...
    describe('addCompetency', () => {
        it('should add a new competency', () => {
            const result = LongTermNoteManagementService.addCompetency(mockNote, 'Writing Skills', 'Ability to write clear, coherent text');
        ...
        it('should update lastModified', () => {
            ...
            const result = LongTermNoteManagementService.addCompetency(mockNote, 'Writing Skills', 'Ability to write clear text');
    ...
    describe('recordCompetencyAssessment', () => {
        it('should record a competency assessment', () => {
            const result = LongTermNoteManagementService.recordCompetencyAssessment(mockNote, 'comp-1', 85, 'exam-2');
        ...
        it('should not affect other competencies', () => {
            const result = LongTermNoteManagementService.recordCompetencyAssessment(mockNote, 'nonexistent', 85);
    ...
    describe('addDevelopmentNote', () => {
        it('should add a new development note', () => {
            const result = LongTermNoteManagementService.addDevelopmentNote(mockNote, 'Struggled with geometry concepts', 'challenge');
        ...
        it('should preserve existing notes', () => {
            const result = LongTermNoteManagementService.addDevelopmentNote(mockNote, 'New achievement note', 'achievement');
            expect(result.developmentNotes[0]).toEqual(mockNote.developmentNotes[0]);
        });
        it('should handle different categories', () => {
            const achievement = LongTermNoteManagementService.addDevelopmentNote(mockNote, 'Great test score', 'achievement');
            expect(achievement.developmentNotes[1].category).toBe('achievement');
            const observation = LongTermNoteManagementService.addDevelopmentNote(mockNote, 'Student participates actively', 'observation');
            expect(observation.developmentNotes[1].category).toBe('observation');
        });
    });
    describe('updateDevelopmentNote', () => {
        it('should update an existing note', () => {
            const result = LongTermNoteManagementService.updateDevelopmentNote(mockNote, 'dev-1', 'Updated content');
            const updated = result.developmentNotes.find(n => n.id === 'dev-1');
            expect(updated?.content).toBe('Updated content');
        });
        it('should change category if provided', () => {
            const result = LongTermNoteManagementService.updateDevelopmentNote(mockNote, 'dev-1', 'Same content', 'challenge');
            const updated = result.developmentNotes.find(n => n.id === 'dev-1');
            expect(updated?.category).toBe('challenge');
        });
        it('should not affect non-matching notes', () => {
            const result = LongTermNoteManagementService.updateDevelopmentNote(mockNote, 'nonexistent', 'New content');
            expect(result.developmentNotes[0]).toEqual(mockNote.developmentNotes[0]);
        });
    });
    describe('removeDevelopmentNote', () => {
        it('should remove a development note', () => {
            const result = LongTermNoteManagementService.removeDevelopmentNote(mockNote, 'dev-1');
            expect(result.developmentNotes).toHaveLength(0);
        });
        it('should not affect other notes', () => {
            const withTwo = LongTermNoteManagementService.addDevelopmentNote(mockNote, 'Second note', 'observation');
            const result = LongTermNoteManagementService.removeDevelopmentNote(withTwo, 'dev-1');
    ...
    describe('updateStrengths', () => {
        it('should replace strengths', () => {
            const result = LongTermNoteManagementService.updateStrengths(mockNote, ['New Strength', 'Another One']);
            expect(result.strengths).toEqual(['New Strength', 'Another One']);
        });
    });
    describe('addStrength', () => {
        it('should add a new strength', () => {
            const result = LongTermNoteManagementService.addStrength(mockNote, 'Creativity');
            expect(result.strengths).toContain('Creativity');
            expect(result.strengths).toHaveLength(3);
        });
        it('should not add duplicate strengths', () => {
            const result = LongTermNoteManagementService.addStrength(mockNote, 'Logical thinking');
    ...
    describe('calculateCompetencyProgress', () => {
        it('should calculate progress with multiple assessments', () => {
            ...
            const result = LongTermNoteManagementService.calculateCompetencyProgress(mockNote.competencyAreas[0], assessments);
        ...
        it('should handle empty assessments', () => {
            const result = LongTermNoteManagementService.calculateCompetencyProgress(mockNote.competencyAreas[0], []);
    ...
    describe('identifyStudentsNeedingSupport', () => {
        it('should identify students with multiple focus areas', () => {
            ...
            const result = LongTermNoteManagementService.identifyStudentsNeedingSupport(notes, { minFocusAreas: 2 });
        ...
        it('should identify students with challenges', () => {
            ...
            const result = LongTermNoteManagementService.identifyStudentsNeedingSupport([withChallenge], { hasChallenges: true });
            expect(result).toHaveLength(1);
        });
    ...
    describe('generateProgressSummary', () => {
        it('should generate a text summary', () => {
            ...
            const result = LongTermNoteManagementService.generateProgressSummary(mockNote, growth);
