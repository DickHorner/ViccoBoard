...
- Understand the ViccoBoard architecture before reviewing (see `agents.md`, `Plan.md`, and `docs/agents/SPORTZENS_PARITY_v2.md`)
...
- `docs/agents/SPORTZENS_PARITY_v2.md` - Mandatory parity scope, gates, and execution guidance
