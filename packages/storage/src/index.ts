...
export * from './migrations/006_exam_schema';
export * from './migrations/007_correction_schema';
...
export * from './migrations/indexeddb/006_exam_schema';
export * from './migrations/indexeddb/007_correction_schema';
